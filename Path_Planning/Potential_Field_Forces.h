...
// Input of the module : std::tuple<double,double> position of the center of the robot
//                       std::tuple<double,double> orientation of the robot
// Output              : std::tuple<double,double> vRef and omega ref
...
public:
    ...
    // constructors
    Potential_Field();
    explicit Potential_Field(const std::tuple <double, double>& position);
